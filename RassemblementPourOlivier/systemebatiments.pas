...
Var MaisonColon,CoutColMaisonCit,MaisonCitoyens,CentreVille,Chapelle,CabanePecheur,CabaneBucheron,Bergerie,AtelierTissus,TestTypeBatiment,TestIndustrie,TestBatimentSociaux,nbBat,nbOr,CoutOrMaisonCol:Integer;
CoutBoisMaisonCit, CoutOutilsMaisonCol, CoutBoisMaisonCol, CoutOutilsMaisonCit, nbBois,nbOutils, ValEntrepot, nbEntrepot, nbMaisonCol : Integer;
 ...
 Begin
    ...
    CASE TypeBatiment OF
      ...
      BEGIN
        ...
        END;
        IF (ComparRess(getMaisonColon(),CoutColMaisonCit)) and (ComparRess(getBois(),CoutBoisMaisonCit)) and (ComparRess(getOutils(),CoutOutilsMaisonCit)) THEN BEGIN
          CurseurRess.y := CurseurRess.y + 1;
          deplacerCurseur(CurseurRess);
