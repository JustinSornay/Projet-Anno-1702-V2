...
Var
    ...
    deplacerCurseur(CurseurRess);
      ...
      Readln(nbBat);
        ...
        IF (ComparRess(getCabanePecheur(),nbBat)) THEN BEGIN     //Si le joueur a assez de Cabane de pecheur à détruire
        ...
        END
        ELSE BEGIN  //Si le joueur a assez de Cabane de pecheur à détruire
        CurseurRess.y := CurseurRess.y + 1;
        deplacerCurseur(CurseurRess);
