...
// Procedure pour Gérer un batiments
procedure GestionBatiments();
// Procedure pour créer un batiments
procedure CreeBatiments();
// Procedure pour Detruire un batiments
procedure DetruireBatiments();
// Procedure qui affiche les ressources et les Batiments
...
BEGIN
  ...
  InfoRessource();  //Affiche le cadre des ressources
