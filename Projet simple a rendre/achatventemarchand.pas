...
{****************Acheter***********************}
  ...
  //Achat d'Outils' avec le marchand
...
{****************Vendre***********************}
   //Vendre du Bois avec le marchand
     PROCEDURE VendreBois();
   //Vendre du Poissons avec le marchand
     PROCEDURE VendrePoissons();
   //Vendre des Outils avec le marchand
     PROCEDURE VendreOutils();
   //Vendre de la laines avec le marchand
    PROCEDURE VendreLaines();
   //Vendre du Tissus avec le marchand
