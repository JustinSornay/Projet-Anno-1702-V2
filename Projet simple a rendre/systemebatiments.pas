...
//Procedure qui class les types de batiments lors de la création
Procedure PTypeCreateBatiment();

//Procedure de construction de Batiment
Procedure ConstructionsBatiments();

//Procedure de destruction un batiment
...
//Fonction qui renvoie la valeur de RetourCreeBat
 FUNCTION getRetourBat(): BOOLEAN;
 BEGIN
    ...
    CASE TypeBatiment OF
      ...
      BEGIN
        ...
        1 :  BEGIN  //Pour les Maisons des Colons
            ...
            0 : BEGIN
                    //Fonction de retour, rien faire pour continuer boucle
                END;
            END;
            END;
 ...
 Begin
    ...
    CASE TypeBatiment OF
      ...
      BEGIN
        ...
        CASE TestTypeBatiment OF
        1 :  BEGIN  //Pour détruire les Maisons des Colons
