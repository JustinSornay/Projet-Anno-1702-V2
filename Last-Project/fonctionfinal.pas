...
uses
  Classes, SysUtils, SystemeBatiments, ressources, GestionEcran, GestionErreur, Image, CadreInfoBat, GestionMarchand,SystemeTour;

  // Procedure finale pour Gérer un batiments
  procedure GestionBatiments();

  //Procedure finale pour Gérer un batiment millitaire
  procedure GestionBatimentsMillitaire();

  //Procedure finale pour Gérer un batiment millitaire  avec recrutement
procedure GestionBatimentsMillitaire2();

    //Procedure finale pour Gérer un batiment millitaire avec le recrutement
  procedure GestionBatimentsMillitaireRecru();

// Procedure finale pour créer un batiments
procedure CreeBatiments();

//Procedure finale pour creer un batiment millitaire
procedure CreeBatimentsMillitaires();

//Procedure finale pour recruter des soldats
procedure RecrutementArmee();

// Procedure finale pour Detruire un batiments
procedure DetruireBatiments();

//Procedure finale pour Detruire un batiment millitaire
procedure DetruireBatimentsMillitaire();
...
var
  ...
  CreeOuDetruire : INTEGER;
   ...
   CadreDialogue();
    AfficheTour();//Créer le cadre dialogue
...
var
  ...
  CreeOuDetruire2 : INTEGER;
   ...
   CurseurRess.y := CurseurRess.y + 1;
   deplacerCurseur(CurseurRess);
   readln(CreeOuDetruire2);


   CASE CreeOuDetruire2 OF
     1 : BEGIN
          WHILE getRetourBat() = FALSE DO BEGIN
              CreeBatimentsMillitaires();
            IF getRetourBat() = FALSE THEN BEGIN
              GestionBatimentsMillitaire();
            END;
          END;
         END;
...
var
  ...
  CreeOuDetruire3 : INTEGER;
   ...
   CurseurRess.y := CurseurRess.y + 1;
   deplacerCurseur(CurseurRess);
   readln(CreeOuDetruire3);


   CASE CreeOuDetruire3 OF
     1 : BEGIN
          WHILE getRetourBat() = FALSE DO BEGIN
              CreeBatimentsMillitaires();
            IF getRetourBat() = FALSE THEN BEGIN
              GestionBatimentsMillitaire2();
            END;
          END;
         END;
     ...
     3 : BEGIN
          WHILE getRetourBat() = FALSE DO BEGIN
              GestionBatimentsMillitaireRecru();
            IF getRetourBat() = FALSE THEN BEGIN
              GestionBatimentsMillitaire2();
            END;
          END;
...
var
  ...
  CreeOuDetruire4 : INTEGER;
   ...
   CurseurRess.y := CurseurRess.y + 1;
   deplacerCurseur(CurseurRess);
   readln(CreeOuDetruire4);


   CASE CreeOuDetruire4 OF
     1 : BEGIN
          WHILE getRetourBat() = FALSE DO BEGIN
              CreeBatimentsMillitaires();
            IF getRetourBat() = FALSE THEN BEGIN
...
BEGIN
  ...
  WHILE getRetourBat() = FALSE DO BEGIN
   ...
   InfoBatArmee();
   InfoCoutBatArmee();
   InfoRessource();    //affiche les ressources et les Batiments
    PTypeDestrucBatimentMillitaire();  //Procedure qui class les types de batiments lors de la destruction
    IF getRetourBat() = FALSE THEN BEGIN
      DestructionsBatimentsMillitaire(); //Procedure de Destruction de Batiment
    END;
  END;
  setRetourBat(FALSE);  // modifie la valeur de retour a False
END;

//procedure final pour recruter une armée
procedure RecrutementArmee();
BEGIN
  ...
  WHILE getRetourBat() = FALSE DO BEGIN
   ...
   InfoCoutRecruArmee();
   InfoRessource();    //affiche les ressources et les Batiments
    PTypeRecrutement();  //Procedure qui class les types de batiments lors de la destruction
    IF getRetourBat() = FALSE THEN BEGIN
      RecruMillitaire(); //Procedure de Destruction de Batiment
    END;
  END;
  setRetourBat(FALSE);  // modifie la valeur de retour a False
END;
...
BEGIN
 ...
 WHILE getRetourBat() = FALSE DO BEGIN
  ...
  InfoCoutBatArmee();
  ImgPlage(); //Image plage
  PTypeCreateBatimentMillitaires();  //Procedure qui class les types de batiments
  IF getRetourBat() = FALSE THEN BEGIN
    ConstructionBatimentsMillitaire(); //Procedure de construction de Batiment
  END;
 END;
 setRetourBat(FALSE);  // modifie la valeur de retour a False
END;
