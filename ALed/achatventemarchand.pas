...
//Achat de Bois avec le marchand
  ...
  deplacerCurseur(CurseurRess);
    ...
    Readln(NbRessources);
      ...
      IF (ComparRess(getGold(),MarchandCoutBois()) AND (getValEntrepot() > getBois())) THEN BEGIN     //Si le joueur a assez d'or
  ...
  //Achat de Poissons avec le marchand
    ...
    deplacerCurseur(CurseurRess);
      ...
      Readln(NbRessources);
        ...
        IF (ComparRess(getGold(),MarchandCoutpoissons()) AND (getValEntrepot() > getPoissons())) THEN BEGIN     //Si le joueur a assez d'or
    ...
    //Achat de Outils avec le marchand
      ...
      deplacerCurseur(CurseurRess);
        ...
        Readln(NbRessources);
          ...
          IF (ComparRess(getGold(),MarchandCoutOutils()) AND (getValEntrepot() > getOutils())) THEN BEGIN     //Si le joueur a assez d'or
      ...
      //Achat de Laines avec le marchand
        ...
        deplacerCurseur(CurseurRess);
          ...
          Readln(NbRessources);
            ...
            IF (ComparRess(getGold(),MarchandCoutLaine()) AND (getValEntrepot() > getLaines())) THEN BEGIN     //Si le joueur a assez d'or
        ...
        //Achat de Tissus avec le marchand
          ...
          deplacerCurseur(CurseurRess);
            ...
            Readln(NbRessources);
              ...
              IF (ComparRess(getGold(),MarchandCoutTissus()) AND (getValEntrepot() > getTissus())) THEN BEGIN     //Si le joueur a assez d'or
